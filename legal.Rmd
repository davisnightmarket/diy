...
1. You're probably fine anyway (see point 1). also, seriously, you're fine if you're in certain states (like CA, CO), so it's worth looking at the specifics for your state. also, good for you, for not being a part of this horrendous system :)  
...
"If you are interested in some of the different ways fiscal sponsorship can be done, Gregory Colvin and Stephanie Petit have a good summary of the [different types of fiscal sponsorships here](https://www.adlercolvin.com/wp-content/uploads/2017/12/Fiscal-Sponorship-Six-Ways-To-Do-It-Right-A-Synopsis.pdf)" (paraphrased from [big door brigade](http://bigdoorbrigade.com/category/handling-money-and-taxes/))
...
* The type of food you're going to be dealing with: 
      <img src="photos/delicious-food-cartoon.jpeg" style="width:100px;height:100px;" align="right">
...
The Night Market recovers food from restaurants and other eateries, so you'll be dealing with  perishable food (cooked meals) as well as non-perishables and produce. In addition, you'll often have to do same day storage and portion out the food into individual containers. 
...
everything (INCLUDING EXPIRED FOOD) except 
...
So i guess no dumpster diving treasures :(
...
<img src="photos/perishable_food_timing.png" style="width:220px;height:220px;" align="right">
  ...
  <img src="photos/temperaturedangerzone.png" style="width:200px;height:200px;" align="right">
<br>
 
A permanently affixed thermometer in cold holding equipment used for PHFs is readily visible and placed in the warmest part of each refrigeration unit.
...
* For portioning, use food-grade containers and label them.
* If food has been served to someone, it can't be returned and served to someone else 
* Use commercial-grade hand sanitaizer or a handwash station to wash hands previously 
...
## EVENT PERMIT
 ...
 <img src="photos/1S9A8354.jpg" style="width:200px;height:200px;" align="right">
<br>
